...
With the parameter type="n2" the analysis considers a trophic chain as running from the top of the food web to the top-2 level. If a food web has a maximum trophic level greater than 3, trophic chains will not go all the way down to the basal species.
...
FoodWebMetrics <- FoodWebAnalysis(MyFoodWeb, type="n2")
head(FoodWebMetrics)
```
